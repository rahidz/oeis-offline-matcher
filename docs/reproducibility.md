...
4. Run `scripts/bench.py` for end-to-end API cases.
5. Use `scripts/profile_matchers.py --case ... --profile out.pstats` before optimizing.
6. Keep a before/after table and verify the full test suite; do not accept a speedup that changes uncapped results.
